...
class MemberApi(Resource):
    def __init__(self):
        ...
        parser.add_argument('tenure', type=int)
        parser.add_argument('stock_qty', type=int)
        parser.add_argument('balance', type=float)
        parser.add_argument('has_credit', type=int)
        parser.add_argument('credit_score', type=int)
        parser.add_argument('is_active_member', type=int, required=False, help='This field cannot be left blank')
        parser.add_argument('estimated_salary', type=float)
        parser.add_argument('role', type=str, required=False, help='This field cannot be left blank')
        parser.add_argument('exited', type=int)
